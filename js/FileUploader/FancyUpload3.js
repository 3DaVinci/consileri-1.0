...
FancyUpload3.Attach.File = new Class({
	...
	render: function() {
		...
		this.ui.tr = new Element('tr', {'class': 'filetr', id: 'tr-'+this.id});
		this.ui.commenttd = new Element('td',{id: 'commenttd-'+this.id});
		this.ui.element = new Element('td',{'class': 'file',id: 'filetd-'+this.id});
		...
		this.ui.tr.highlight();
		
		var progress = new Element('img', {'class': 'file-progress', src: window.siteurl+'/images/assets/progress-bar/bar.gif'}).inject(this.ui.commenttd);
